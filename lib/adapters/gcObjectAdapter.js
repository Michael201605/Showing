...
GcObjectAdapter.prototype.monitor_gcObject_callback = function (monitored_node, dataValueOfMonitor, me) {
    ...
    console.log('monitor_gcObject_callback');
    console.dir(dataValueOfMonitor.value.dataType );
    if (dataValueOfMonitor.value.dataType.key === 'Boolean') {
        console.log('It is boolean type');
        ...
        console.log('dataValueOfMonitor.value.dataType: ' + dataValueOfMonitor.value.dataType);
    }
