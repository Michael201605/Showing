...
var monitored_node = argv.node || "ns=1;s=PLC1.G054M.A_1006.A_1006_MXZ01.StCode"; //"ns=1;s=Temperature";
...
async.series([
        ...
        client.getEndpointsRequest(function (err, endpoints) {
            ...
            if (!err) {
                endpoints.forEach(function (endpoint, i) {
                    ...
                    var certificate_filename = path.join(__dirname, "../../node_modules/node-opcua/certificates/PKI/server_certificate" + i + ".pem");
    ...
    function (callback) {
        ...
        console.log('AttributeIds.Value: ' + AttributeIds.Value);
        var nodesToWrite = [{
        ...
        the_session.write(nodesToWrite, function(err,statusCode,diagnosticInfo) {
            if (!err) {
                console.log(monitored_node + " write ok" );
            }
        });
    },
